...
<head>
	...
	<link rel="stylesheet" type="text/css" href="resources/css/termos.css">
	<script type="text/javascript" src="resources/js/sweetalert2.min.js"></script>
	<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
	<title>Termos e condições - Restaurante Bucho de Bode</title>
</head>
<body>
...
<div class="artigo-contain">
	<div class="artigo-page" class="artigo-page">

		<h1 class="artigo">VISÃO GERAL</h1>

		<p>Esse site é operado pelo Bucho de Bode. Clique <a href="creators.php">aqui</a> e conheça quem são os responsáveis por ele Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Bucho de Bode. O Bucho de Bode proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 1 - TERMOS DA LOJA VIRTUAL</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 2 - CONDIÇÕES GERAIS</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 3 - PRECISÃO, INTEGRIDADE E ATUALIZAÇÃO DAS INFORMAÇÕES</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 4 - MODIFICAÇÕES DO SERVIÇO E PREÇOS</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 5 - PRODUTOS OU SERVIÇOS (caso aplicável)</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 6 - PRECISÃO DE INFORMAÇÕES DE FATURAMENTO E CONTA</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 7 - FERRAMENTAS OPCIONAIS</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 8 - LINKS DE TERCEIROS</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 9 - COMENTÁRIOS, FEEDBACK, ETC. DO USUÁRIO</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 10 - INFORMAÇÕES PESSOAIS</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 11 - ERROS, IMPRECISÕES E OMISSÕES</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 12 - USOS PROIBIDOS</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 13 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 17 - ACORDO INTEGRAL</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 19 - ALTERAÇÕES DOS TERMOS DE SERVIÇO</h1>
	...
	<div class="artigo-page">
		...
		<h1 class="artigo">SEÇÃO 20 - INFORMAÇÕES DE CONTATO</h1>

		<p>As perguntas sobre os Termos de serviço devem ser enviadas para nós através do contato@buchodebode.com</p>
	</div>
</div>
<?php
	# Faz a requisição do arquivo footer.php 
